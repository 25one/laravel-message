...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="" class="logo">
            ...
            <span class="logo-lg">Messages</span>
        </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(url('/dashboard')); ?>">
                        <i class="fa fa-folder-o"></i> <span>List of Messages - <?php echo e(count($apimessages)); ?></span>
                    </a>
                </li>
            </ul>
        </section>
...
<?php /**PATH /home/alex/www/laravel-message/resources/views/back/layout.blade.php ENDPATH**/ ?>