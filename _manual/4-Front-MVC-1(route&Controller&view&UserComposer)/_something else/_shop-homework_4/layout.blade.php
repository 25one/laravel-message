                ...
                <div class="col-12">
                    <div class="search-content">
                        <form action="/" method="get">
                            ...
                            <!--
                            <input type="search" name="search" id="search" placeholder="Type your keyword..." onkeydown="if(event.which==13){BaseRecord.search($(this).val());return false;}">
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="{{ route('home') }}><img src="{{ asset('public/img/core-img/logo.png') }}" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="{{ route('home') }}"><img src="{{ asset('public/img/core-img/logo2.png') }}" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    $(document).ready(function(){
       $('[value="Subscribe"]').click(function(){
          BaseRecord.subscribe($('.nl-email').val());
          return false;
       });
    });
    </script>
