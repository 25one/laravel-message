...
Auth::routes();
Route::name('letter')->get('/letter', 'Front\ShopController@letter');
...
Route::prefix('')->namespace('Front')->group(function () {
    ...
    Route::middleware('auth')->group(function () {  //!!!ONLY AUTH-USERS
		...
		Route::resource('restmessages', 'MessageController');
		Route::name('deleteprofile')->post('/deleteprofile', 'ShopController@deleteprofile');		
    });
