        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li><div class="cart-fav-search"><a href="<?php echo e(route('cart')); ?>">Cart <span>(<?php if($carts): ?><?php echo e(count($carts)); ?><?php else: ?><?php echo e(0); ?><?php endif; ?>)</span></a></div></li>
                    <?php endif; ?>
                    ...
                    <li>
                       ...
                       <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu dropdown-menu-right size" aria-labelledby="navbarDropdown">
                               ...
                               <?php endif; ?>
                               <?php if(auth()->guard()->check()): ?>
                                  <a class="dropdown-item" href="<?php echo e(route('messages')); ?>">Messages</a>
                                  <a class="dropdown-item deleteprofile" href="#"><span class="red">Delete profile</span></a>                   <form name="deleteprofile" action="<?php echo e(route('deleteprofile')); ?>" method="POST" style="display: none;">
                                                          <?php echo csrf_field(); ?>
                                   </form>
                               <?php endif; ?>
...
</html><?php /**PATH /var/www/html/laravel-shop/resources/views/front/layout.blade.php ENDPATH**/ ?>