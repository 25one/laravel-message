       ...
       <div class="col-md-3">
        ...
        <div class="col-md-6 margin">
            <?php if(session('message-ok')): ?>
                <?php $__env->startComponent('front.messages.components.alert'); ?>
                    <?php $__env->slot('type'); ?>
                        success
                    <?php $__env->endSlot(); ?>
                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="">
                            ...
                            <h4><?php if(isset($message)): ?><?php echo e($message->user->name); ?><?php else: ?><?php echo e(auth()->user()->name); ?><?php endif; ?></h4>
                        </div>
                        <div class="">
                            <label for="name"><?php echo app('translator')->getFromJson('Date of visit'); ?></label>
                            <h4><?php if(isset($message)): ?><?php echo e($message->datevisit); ?><?php else: ?><?php echo e(date('Y-m-d')); ?><?php endif; ?></h4>
                        </div>                                              
...
<?php echo $__env->make('front.messages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-shop/resources/views/front/messages/restmessages/template.blade.php ENDPATH**/ ?>